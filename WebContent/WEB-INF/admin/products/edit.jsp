...
<body>
  <div class="row">
	<%@ include file="/WEB-INF/layout/admin/nav.jsp"%>
	    ...
	    <span class="card-title">Ürün Düzenle</span>
		<form action="/admin/products?action=edit&id=${product.id}" method="post" accept-charset="UTF-8">
	      <div class="input-field col s12">
	        <input type="text" id="name" name="name" class="validate" value="${product.name}"></textarea>
	        <label for="name">Ürün Adı</label>
	      </div>
	      <div class="input-field col s12">
	        <input type="text" id="price" name="price" class="validate" value="${product.price}"></textarea>
	        <label for="price">Ürün Fiyatı</label>
	      </div>
	      <div class="input-field col s12">
	        <select id="category" name="category" value="${product.category_id}">
          ...
          <div class="input-field col s12">
            <input type="text" id="description" name="description" class="validate" value="${product.description}"></textarea>
          ...
          <div class="row">
            ...
            <div class="file-field input-field">
              ...
              <input class="file-path validate" type="text" name="file" placeholder="Resim Yükle" value="${product.image}">
            </div>
          </div>
         </div>
	     <div class='row'>
